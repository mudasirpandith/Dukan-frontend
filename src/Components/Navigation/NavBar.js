  ...
  return (
    <Box maxW={'full'}  >
      ...
      >
        ...
        <Flex flex={{ base: 1 }} justify={{ base: 'right', md: 'left' }}>

          <Stack display={useBreakpointValue({ md: 'flex', base: "none" })} direction={'row'} align={'center'} gap={1}>
        ...
        >
          ...
          <a href={localStorage.getItem('token') ? "/account" : "/signin"}>
            <Button
              ...
              bg={"white"}
            >{localStorage.getItem('token') ? "My Account" : "Sign In"}
            </Button>
          </a>
